...
public static class BoxCastDrawer
{
    ...
    {
        Debug.DrawLine(box[0], box[1], color, 5f);
        Debug.DrawLine(box[1], box[2], color, 5f);
        Debug.DrawLine(box[2], box[3], color, 5f);
        Debug.DrawLine(box[3], box[0], color, 5f);
    }

    private static void ConnectBoxes(Vector2[] firstBox, Vector2[] secondBox, Color color)
    {
        Debug.DrawLine(firstBox[0], secondBox[0], color, 5f);
        Debug.DrawLine(firstBox[1], secondBox[1], color, 5f);
        Debug.DrawLine(firstBox[2], secondBox[2], color, 5f);
        Debug.DrawLine(firstBox[3], secondBox[3], color, 5f);
    }
